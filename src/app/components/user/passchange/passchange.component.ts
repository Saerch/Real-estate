...
export class PasschangeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.Usvc.GetUserById(userDashboard.userid).subscribe( t => {this.Darr = t ; this.mob =t.userMob.toString() ; this.mobMask(); console.log(this.newmob)} );
  }
...
SendOTP(){
  this.Usvc.GenerateOTP(this.mob).subscribe( t => {this.gotp = t.text(); console.log(this.gotp)});
  this.rowOn=false;
}
